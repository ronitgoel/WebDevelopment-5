...
export default function Page() {
    ...
    useEffect(() => {
       fetch(`${process.env.NEXT_PUBLIC_API_URL}api/kitchenitems`)
       .then(res => res.json())
       .then((data) => {
        setProduct(data["Kitchenitems"]);
        setfilterProduct(data["Kitchenitems"]);
       });
    }, []);
                ...
                >
                    ...
                    <FormControl style={{marginLeft:'1rem'}}>
                        <div className = "text-red-500 font-bold text-xl">Select Your Brand</div>
                            <FormControlLabel className = "text-white font-bold hover:bg-yellow-500" value="Pegion" control={<Checkbox checked={checked.checked1} onChange={handleChangeBox} inputProps={{ 'aria-label': 'controlled' }}/>} label="Pegion" />
                            <FormControlLabel className = "text-white font-bold hover:bg-yellow-500" value="Cello" control={<Checkbox checked={checked.checked2} onChange={handleChangeBox} inputProps={{ 'aria-label': 'controlled' }}/>} label="Cello" />
                            <FormControlLabel className = "text-white font-bold hover:bg-yellow-500" value="Milton" control={<Checkbox checked={checked.checked3} onChange={handleChangeBox} inputProps={{ 'aria-label': 'controlled' }}/>} label="Milton" />
                            <FormControlLabel className = "text-white font-bold hover:bg-yellow-500" value="Futura" control={<Checkbox checked={checked.checked4} onChange={handleChangeBox} inputProps={{ 'aria-label': 'controlled' }}/>} label="Futura" />
                            <FormControlLabel className = "text-white font-bold hover:bg-yellow-500" value="Wolpin" control={<Checkbox checked={checked.checked5} onChange={handleChangeBox} inputProps={{ 'aria-label': 'controlled' }}/>} label="Wolpin" />
                            <FormControlLabel className = "text-white font-bold hover:bg-yellow-500" value="Plantex" control={<Checkbox checked={checked.checked6} onChange={handleChangeBox} inputProps={{ 'aria-label': 'controlled' }}/>} label="Plantex" />
                            <FormControlLabel className = "text-white font-bold hover:bg-yellow-500" value="VR" control={<Checkbox checked={checked.checked7} onChange={handleChangeBox} inputProps={{ 'aria-label': 'controlled' }}/>} label="VR" />
                    </FormControl>
                    <FormControl  style={{marginLeft:'1rem'}}>
                        <div className = "text-red-500 font-bold text-xl">Select Your Category</div>
                            <FormControlLabel className = "text-white font-bold hover:bg-yellow-500" value="KitchenTools" control={<Checkbox checked={check.checked8} onChange={handleChangecat} inputProps={{ 'aria-label': 'controlled' }}/>} label="KitchenTools" />
                            <FormControlLabel className = "text-white font-bold hover:bg-yellow-500" value="Cookware" control={<Checkbox checked={check.checked9} onChange={handleChangecat} inputProps={{ 'aria-label': 'controlled' }}/>} label="Cookware" />
                            <FormControlLabel className = "text-white font-bold hover:bg-yellow-500" value="Storage" control={<Checkbox checked={check.checked10} onChange={handleChangecat} inputProps={{ 'aria-label': 'controlled' }}/>} label="Storage" />
                    </FormControl>
