                ...
                >
                    ...
                    <FormControl style={{marginLeft:'1rem'}}>
                        <div className = "text-red-500 font-bold text-xl">Select Your Brand</div>
                            <FormControlLabel className = "text-white font-bold hover:bg-yellow-500" value="Fastrack" control={<Checkbox checked={checked.checked1} onChange={handleChangeBox} inputProps={{ 'aria-label': 'controlled' }}/>} label="Fastrack" />
                            <FormControlLabel className = "text-white font-bold hover:bg-yellow-500" value="Titan" control={<Checkbox checked={checked.checked2} onChange={handleChangeBox} inputProps={{ 'aria-label': 'controlled' }}/>} label="Titan" />
                            <FormControlLabel className = "text-white font-bold hover:bg-yellow-500" value="Casio" control={<Checkbox checked={checked.checked3} onChange={handleChangeBox} inputProps={{ 'aria-label': 'controlled' }}/>} label="Casio" />
                            <FormControlLabel className = "text-white font-bold hover:bg-yellow-500" value="WildHorn" control={<Checkbox checked={checked.checked4} onChange={handleChangeBox} inputProps={{ 'aria-label': 'controlled' }}/>} label="WildHorn" />
                            <FormControlLabel className = "text-white font-bold hover:bg-yellow-500" value="Rolex" control={<Checkbox checked={checked.checked5} onChange={handleChangeBox} inputProps={{ 'aria-label': 'controlled' }}/>} label="Rolex" />
                            <FormControlLabel className = "text-white font-bold hover:bg-yellow-500" value="TimeWear" control={<Checkbox checked={checked.checked6} onChange={handleChangeBox} inputProps={{ 'aria-label': 'controlled' }}/>} label="TimeWear" />
                            <FormControlLabel className = "text-white font-bold hover:bg-yellow-500" value="Tommy" control={<Checkbox checked={checked.checked7} onChange={handleChangeBox} inputProps={{ 'aria-label': 'controlled' }}/>} label="Tommy" />
                    </FormControl>
                    <FormControl  style={{marginLeft:'1rem'}}>
