...
function Display({Shirts}){
  ...
  else
  {
      return(
          Shirts.map((Shirt) => (
              <Content2 key={Shirt.key} name={Shirt.name} price={Shirt.price} image={Shirt.image} details={Shirt.details} link={Shirt.link} review={Shirt.review}>
              </Content2>
          ))
      )
  }
...
export default function Page() {
    ...
    useEffect(() => {
       fetch(`${process.env.NEXT_PUBLIC_API_URL}api/footwears`)
       .then(res => res.json())
       .then((data) => {
        setProduct(data["Footwears"]);
        setfilterProduct(data["Footwears"]);
       });
    }, []);
                ...
                >
                    ...
                    <FormControl style={{marginLeft:'1rem'}}>
                        <FormLabel className = "text-red-500 font-bold text-xl">Select Your Brand</FormLabel>
                            <FormControlLabel className = "text-white font-bold hover:bg-yellow-500" value="Bata" control={<Checkbox checked={checked.checked1} onChange={handleChangeBox} inputProps={{ 'aria-label': 'controlled' }}/>} label="Bata" />
                            <FormControlLabel className = "text-white font-bold hover:bg-yellow-500" value="Flite" control={<Checkbox checked={checked.checked2} onChange={handleChangeBox} inputProps={{ 'aria-label': 'controlled' }}/>} label="Flite" />
                            <FormControlLabel className = "text-white font-bold hover:bg-yellow-500" value="Campus" control={<Checkbox checked={checked.checked3} onChange={handleChangeBox} inputProps={{ 'aria-label': 'controlled' }}/>} label="Campus" />
                            <FormControlLabel className = "text-white font-bold hover:bg-yellow-500" value="Action" control={<Checkbox checked={checked.checked4} onChange={handleChangeBox} inputProps={{ 'aria-label': 'controlled' }}/>} label="Action" />
                            <FormControlLabel className = "text-white font-bold hover:bg-yellow-500" value="Liberty" control={<Checkbox checked={checked.checked5} onChange={handleChangeBox} inputProps={{ 'aria-label': 'controlled' }}/>} label="Liberty" />
                            <FormControlLabel className = "text-white font-bold hover:bg-yellow-500" value="Adidas" control={<Checkbox checked={checked.checked6} onChange={handleChangeBox} inputProps={{ 'aria-label': 'controlled' }}/>} label="Adidas" />
                            <FormControlLabel className = "text-white font-bold hover:bg-yellow-500" value="RedTape" control={<Checkbox checked={checked.checked7} onChange={handleChangeBox} inputProps={{ 'aria-label': 'controlled' }}/>} label="RedTape" />
                    </FormControl>
                    <FormControl  style={{marginLeft:'1rem'}}>
