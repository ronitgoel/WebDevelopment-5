...
export default function Page({params}) {
  ...
  useEffect(() => {
     ...
     .then(res => res.json())
     .then((data) => setProduct(data["Footwears"]));
  }, []);
  let name = 'hello';
  let image = [];
  let details = 'hello';
  ...
  <div className="text-gray-800 bg-yellow-500 body-font overflow-hidden py-24">
    <div className="lg:w-4/5 mx-auto flex flex-wrap">
        ...
        >
            <SwiperSlide>
            <Image  style={{height:'auto', width:'350px',marginLeft:'25px', marginTop:'100px'}} alt="ecommerce" width={500} height={500} src={`/${image[0]}`}></Image>
            </SwiperSlide>
            <SwiperSlide>
            <Image  style={{height:'auto', width:'350px',marginLeft:'25px', marginTop:'100px'}} alt="ecommerce" width={500} height={500} src={`/${image[0]}`}></Image>
            </SwiperSlide>
                ...
                <div className="flex">
                    ...
                    <div className="bg-orange-200">
                        <ToggleButtonGroup value={size} exclusive onChange={handlesize} color="warning" size="medium">    
                            <ToggleButton value="Small" variant="contained" className="border-2 border-red-800 font-bold bg-purple-500 hover:bg-purple-700">Small(5)</ToggleButton>
                            <ToggleButton value="Medium" variant="contained" className="border-2 border-red-800 font-bold bg-purple-500 hover:bg-purple-700">Medium(7)</ToggleButton>
                            <ToggleButton value="Large" variant="contained" className="border-2 border-red-800 font-bold bg-purple-500 hover:bg-purple-700">Large(9)</ToggleButton>
                        </ToggleButtonGroup>
                    </div>
                </div>
            </div>
                ...
                <SwiperSlide key = {Shirt.key} style={{width:"auto", height:"500"}}>
                    <Card sx={{ maxHeight : 500 }} style={{margin:"2rem"}} className="bg-blue-950 shadow-2xl shadow-indigo-500/50">
                        ...
                        <div className="bg-white h-[300px] w-[300px] transition ease-in-out delay-150 hover:-translate-y-1 hover:scale-110 duration-300 ...">
                            <Image style={{height:'auto', width:'300px',margin:'auto', paddingTop:'3rem'}} src={`/${Shirt.image[0]}`} width={500} height={350} alt="Photo"></Image>
                        </div>
                        <CardContent>
