...
export default function Page() {
    ...
    useEffect(() => {
       fetch(`${process.env.NEXT_PUBLIC_API_URL}api/shirts`)
       .then(res => res.json())
       .then((data) => {
        setProduct(data["Shirts"]);
        setfilterProduct(data["Shirts"]);
       });
    }, []);
    const [state, setState] = React.useState({
      ...
      const handleChangecat = (event2) => {
        const value2 = event2.target.value;
        setCheck(prevValue => {
            if (value2 == "Men")
            {
                prevValue.checked8 === true ? cat.delete(value2) : cat.add(value2);
                return {
            ...
            else if (value2 == "Women")
            {
                prevValue.checked9 === true ? cat.delete(value2) : cat.add(value2);
                return {
                    checked8: prevValue.checked8,
                    checked9:!prevValue.checked9,
                    checked10: prevValue.checked10
            ...
            {
                prevValue.checked10 === true ? cat.delete(value2) : cat.add(value2);
                return {
                    checked8: prevValue.checked8,
                    checked9: prevValue.checked9,
                    checked10:!prevValue.checked10
                ...
                >
                    ...
                    <FormControl style={{marginLeft:'1rem'}}>
                        <div className = "text-red-500 font-bold text-xl">Select Your Brand</div>
                            <FormControlLabel className = "text-white font-bold hover:bg-yellow-500" value="Richlook" control={<Checkbox checked= {checked.checked1} onChange={handleChangeBox} inputProps={{ 'aria-label': 'controlled' }}/>} label="Richlook" />
                            <FormControlLabel className = "text-white font-bold hover:bg-yellow-500" value="Polo" control={<Checkbox checked={checked.checked2} onChange={handleChangeBox} inputProps={{ 'aria-label': 'controlled' }}/>} label="Polo" />
                            <FormControlLabel className = "text-white font-bold hover:bg-yellow-500" value="LondonHills" control={<Checkbox checked={checked.checked3} onChange={handleChangeBox} inputProps={{ 'aria-label': 'controlled' }}/>} label="LondonHills" />
                            <FormControlLabel className = "text-white font-bold hover:bg-yellow-500" value="Jockey" control={<Checkbox checked={checked.checked4} onChange={handleChangeBox} inputProps={{ 'aria-label': 'controlled' }}/>} label="Jockey" />
                            <FormControlLabel className = "text-white font-bold hover:bg-yellow-500" value="MonteCarlo" control={<Checkbox checked={checked.checked5} onChange={handleChangeBox} inputProps={{ 'aria-label': 'controlled' }}/>} label="MonteCarlo" />
                            <FormControlLabel className = "text-white font-bold hover:bg-yellow-500" value="Madhav" control={<Checkbox checked={checked.checked6} onChange={handleChangeBox} inputProps={{ 'aria-label': 'controlled' }}/>} label="Madhav" />
                            <FormControlLabel className = "text-white font-bold hover:bg-yellow-500" value="HushBunny" control={<Checkbox checked={checked.checked7} onChange={handleChangeBox} inputProps={{ 'aria-label': 'controlled' }}/>} label="HushBunny" />
                    </FormControl>
                    <FormControl  style={{marginLeft:'1rem'}}>
                        <div className = "text-red-500 font-bold text-xl">Select Your Category</div>
                            <FormControlLabel className = "text-white font-bold hover:bg-yellow-500" value="Men" control={<Checkbox checked={check.checked8} onChange={handleChangecat} inputProps={{ 'aria-label': 'controlled' }}/>} label="Men" />
                            <FormControlLabel className = "text-white font-bold hover:bg-yellow-500" value="Women" control={<Checkbox checked={check.checked9} onChange={handleChangecat} inputProps={{ 'aria-label': 'controlled' }}/>} label="Women" />
                            <FormControlLabel className = "text-white font-bold hover:bg-yellow-500" value="Child" control={<Checkbox checked={check.checked10} onChange={handleChangecat} inputProps={{ 'aria-label': 'controlled' }}/>} label="Child" />
                    </FormControl>
