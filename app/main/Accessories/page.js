...
export default function Page() {
    ...
    useEffect(() => {
       ...
       .then(res => res.json())
       .then((data) => {
        setProduct(data["Accessories"]);
        setfilterProduct(data["Accessories"]);
       });
    }, []);
                ...
                >
                    ...
                    <FormControl style={{marginLeft:'1rem'}}>
                        <FormLabel className = "text-red-500 font-bold text-xl">Select Your Brand</FormLabel>
                            ...
                            <FormControlLabel className = "text-white font-bold hover:bg-yellow-500" value="Andoitz" control={<Checkbox checked={checked.checked4} onChange={handleChangeBox} inputProps={{ 'aria-label': 'controlled' }}/>} label="Andoitz" />
                            <FormControlLabel className = "text-white font-bold hover:bg-yellow-500" value="Pearl" control={<Checkbox checked={checked.checked5} onChange={handleChangeBox} inputProps={{ 'aria-label': 'controlled' }}/>} label="Pearl" />
                            <FormControlLabel className = "text-white font-bold hover:bg-yellow-500" value="Lukzer" control={<Checkbox checked={checked.checked6} onChange={handleChangeBox} inputProps={{ 'aria-label': 'controlled' }}/>} label="Lukzer" />
