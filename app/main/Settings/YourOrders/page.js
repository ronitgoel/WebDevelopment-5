...
export default function Page() {
  const {Orderedlist} = useContext(OrderedContext);
  function Create() {
  ...
  return (
    <div style = {{backgroundImage: 'url("https://img.freepik.com/free-photo/green-park-view_1417-1487.jpg?w=2000")', backgroundSize: 'cover', backgroundRepeat: 'no-repeat',}}>
      <br></br>
      <br></br>
      <div className = "text-3xl bg-blue-300 rounded-xl font-bold text-center text-blue-900 w-full sm:w-[300px]" style={{margin:'auto'}}>Your Ordered Items</div>
      <br></br>
      <br></br>
