...
export default function Page() {
    ...
    useEffect(() => {
       fetch("http://localhost:3000/api/babies")
       .then(res => res.json())
       .then((data) => {
        setProduct(data["Babies"]);
        setfilterProduct(data["Babies"]);
       });
    }, []);
                ...
                >
                    ...
                    <FormControl style={{marginLeft:'1rem'}}>
                        <FormLabel className = "text-red-500 font-bold text-xl">Select Your Brand</FormLabel>
                            <FormControlLabel className = "text-white font-bold hover:bg-yellow-500" value="Himalaya" control={<Checkbox checked={checked.checked1} onChange={handleChangeBox} inputProps={{ 'aria-label': 'controlled' }}/>} label="Himalaya" />
                            <FormControlLabel className = "text-white font-bold hover:bg-yellow-500" value="Pampers" control={<Checkbox checked={checked.checked2} onChange={handleChangeBox} inputProps={{ 'aria-label': 'controlled' }}/>} label="Pampers" />
                            <FormControlLabel className = "text-white font-bold hover:bg-yellow-500" value="Mamaearth" control={<Checkbox checked={checked.checked3} onChange={handleChangeBox} inputProps={{ 'aria-label': 'controlled' }}/>} label="Mamaearth" />
                            <FormControlLabel className = "text-white font-bold hover:bg-yellow-500" value="Huggies" control={<Checkbox checked={checked.checked4} onChange={handleChangeBox} inputProps={{ 'aria-label': 'controlled' }}/>} label="Huggies" />
                            <FormControlLabel className = "text-white font-bold hover:bg-yellow-500" value="Mothercare" control={<Checkbox checked={checked.checked5} onChange={handleChangeBox} inputProps={{ 'aria-label': 'controlled' }}/>} label="Mothercare" />
                            <FormControlLabel className = "text-white font-bold hover:bg-yellow-500" value="Johnsons" control={<Checkbox checked={checked.checked6} onChange={handleChangeBox} inputProps={{ 'aria-label': 'controlled' }}/>} label="Johnsons" />
                            <FormControlLabel className = "text-white font-bold hover:bg-yellow-500" value="BeeBee" control={<Checkbox checked={checked.checked7} onChange={handleChangeBox} inputProps={{ 'aria-label': 'controlled' }}/>} label="BeeBee" />
                    </FormControl>
                    <FormControl  style={{marginLeft:'1rem'}}>
                        <FormLabel className = "text-red-500 font-bold text-xl">Select Your Category</FormLabel>
                            <FormControlLabel className = "text-white font-bold hover:bg-yellow-500" value="Carrier" control={<Checkbox checked={check.checked8} onChange={handleChangecat} inputProps={{ 'aria-label': 'controlled' }}/>} label="Carrier" />
                            <FormControlLabel className = "text-white font-bold hover:bg-yellow-500" value="Care" control={<Checkbox checked={check.checked9} onChange={handleChangecat} inputProps={{ 'aria-label': 'controlled' }}/>} label="Care" />
                            <FormControlLabel className = "text-white font-bold hover:bg-yellow-500" value="Clothing" control={<Checkbox checked={check.checked10} onChange={handleChangecat} inputProps={{ 'aria-label': 'controlled' }}/>} label="Clothing" />
                    </FormControl>
