...
export default function Page() {
    ...
    useEffect(() => {
       ...
       .then(res => res.json())
       .then((data) => {
        setProduct(data["Homes"]);
        setfilterProduct(data["Homes"]);
       });
    }, []);
                ...
                >
                    ...
                    <FormControl style={{marginLeft:'1rem'}}>
                        <FormLabel className = "text-red-500 font-bold text-xl">Select Your Brand</FormLabel>
                            <FormControlLabel className = "text-white font-bold hover:bg-yellow-500" value="Kuber" control={<Checkbox checked={checked.checked1} onChange={handleChangeBox} inputProps={{ 'aria-label': 'controlled' }}/>} label="Kuber" />
                            <FormControlLabel className = "text-white font-bold hover:bg-yellow-500" value="Indulge" control={<Checkbox checked={checked.checked2} onChange={handleChangeBox} inputProps={{ 'aria-label': 'controlled' }}/>} label="Indulge" />
                            <FormControlLabel className = "text-white font-bold hover:bg-yellow-500" value="Sparkle" control={<Checkbox checked={checked.checked3} onChange={handleChangeBox} inputProps={{ 'aria-label': 'controlled' }}/>} label="Sparkle" />
                            <FormControlLabel className = "text-white font-bold hover:bg-yellow-500" value="Plantex" control={<Checkbox checked={checked.checked4} onChange={handleChangeBox} inputProps={{ 'aria-label': 'controlled' }}/>} label="Plantex" />
                            <FormControlLabel className = "text-white font-bold hover:bg-yellow-500" value="Milton" control={<Checkbox checked={checked.checked5} onChange={handleChangeBox} inputProps={{ 'aria-label': 'controlled' }}/>} label="Milton" />
                            ...
                            <FormControlLabel className = "text-white font-bold hover:bg-yellow-500" value="Decor" control={<Checkbox checked={checked.checked7} onChange={handleChangeBox} inputProps={{ 'aria-label': 'controlled' }}/>} label="Decor" />
                    </FormControl>
                    <FormControl  style={{marginLeft:'1rem'}}>
                        <FormLabel className = "text-red-500 font-bold text-xl">Select Your Category</FormLabel>
                            <FormControlLabel className = "text-white font-bold hover:bg-yellow-500" value="Bathroom" control={<Checkbox checked={check.checked8} onChange={handleChangecat} inputProps={{ 'aria-label': 'controlled' }}/>} label="Bathroom" />
                            <FormControlLabel className = "text-white font-bold hover:bg-yellow-500" value="BedRoom" control={<Checkbox checked={check.checked9} onChange={handleChangecat} inputProps={{ 'aria-label': 'controlled' }}/>} label="BedRoom" />
