...
export default function Page() {
    ...
    useEffect(() => {
       fetch(`${process.env.NEXT_PUBLIC_API_URL}api/softwares`)
       .then(res => res.json())
       .then((data) => {
        setProduct(data["Softwares"]);
        setfilterProduct(data["Softwares"]);
       });
    }, []);
                ...
                >
                    ...
                    <FormControl style={{marginLeft:'1rem'}}>
                        <FormLabel className = "text-red-500 font-bold text-xl">Select Your Brand</FormLabel>
                            <FormControlLabel className = "text-white font-bold hover:bg-yellow-500" value="McAfee" control={<Checkbox checked={checked.checked1} onChange={handleChangeBox} inputProps={{ 'aria-label': 'controlled' }}/>} label="McAfee" />
                            <FormControlLabel className = "text-white font-bold hover:bg-yellow-500" value="Microsoft" control={<Checkbox checked={checked.checked2} onChange={handleChangeBox} inputProps={{ 'aria-label': 'controlled' }}/>} label="Microsoft" />
                            <FormControlLabel className = "text-white font-bold hover:bg-yellow-500" value="Norton" control={<Checkbox checked={checked.checked3} onChange={handleChangeBox} inputProps={{ 'aria-label': 'controlled' }}/>} label="Norton" />
                            <FormControlLabel className = "text-white font-bold hover:bg-yellow-500" value="TechGuy" control={<Checkbox checked={checked.checked4} onChange={handleChangeBox} inputProps={{ 'aria-label': 'controlled' }}/>} label="TechGuy" />
                            <FormControlLabel className = "text-white font-bold hover:bg-yellow-500" value="SystMade" control={<Checkbox checked={checked.checked5} onChange={handleChangeBox} inputProps={{ 'aria-label': 'controlled' }}/>} label="SystMade" />
                            <FormControlLabel className = "text-white font-bold hover:bg-yellow-500" value="Demon" control={<Checkbox checked={checked.checked6} onChange={handleChangeBox} inputProps={{ 'aria-label': 'controlled' }}/>} label="Demon" />
                            <FormControlLabel className = "text-white font-bold hover:bg-yellow-500" value="Soft" control={<Checkbox checked={checked.checked7} onChange={handleChangeBox} inputProps={{ 'aria-label': 'controlled' }}/>} label="Soft" />
                    </FormControl>
                    <FormControl  style={{marginLeft:'1rem'}}>
                        <FormLabel className = "text-red-500 font-bold text-xl">Select Your Category</FormLabel>
                            <FormControlLabel className = "text-white font-bold hover:bg-yellow-500" value="AntiVirus" control={<Checkbox checked={check.checked8} onChange={handleChangecat} inputProps={{ 'aria-label': 'controlled' }}/>} label="AntiVirus" />
                            <FormControlLabel className = "text-white font-bold hover:bg-yellow-500" value="OfficeSuites" control={<Checkbox checked={check.checked9} onChange={handleChangecat} inputProps={{ 'aria-label': 'controlled' }}/>} label="OfficeSuites" />
                            <FormControlLabel className = "text-white font-bold hover:bg-yellow-500" value="SystemUtility" control={<Checkbox checked={check.checked10} onChange={handleChangecat} inputProps={{ 'aria-label': 'controlled' }}/>} label="SystemUtility" />
                    </FormControl>
